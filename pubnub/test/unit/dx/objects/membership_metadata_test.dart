...
void main() {
  ...
  group('DX [objects] [membership]', () {
    ...
    test('#getMemberships()', () async {
      when(
        path:
            'v2/objects/demo/uuids/uuid-2/channels?limit=10&count=true&pnsdk=PubNub-Dart%2F${PubNub.version}&uuid=uuid-1',
        method: 'GET',
    ...
    test('#manageMemberships()', () async {
      when(
              path:
                  'v2/objects/demo/uuids/uuid-1/channels?count=true&pnsdk=PubNub-Dart%2F${PubNub.version}&uuid=uuid-1',
              method: 'PATCH',
    ...
    test('#getChannelMembers()', () async {
      when(
        path:
            'v2/objects/demo/channels/my-channel/uuids?limit=10&count=true&pnsdk=PubNub-Dart%2F${PubNub.version}&uuid=uuid-1',
        method: 'GET',
    ...
    test('#manageChannelMembers()', () async {
      when(
              path:
                  'v2/objects/demo/channels/my-channel/uuids?count=true&pnsdk=PubNub-Dart%2F${PubNub.version}&uuid=uuid-1',
              method: 'PATCH',
