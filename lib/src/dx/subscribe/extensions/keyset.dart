...
extension SubscribeKeysetExtension on Keyset {
  String get filterExpression => settings[#finalExpression];
  set filterExpression(String value) => settings[#finalExpression] = value;

  SubscriptionManager get subscriptionManager => settings[#subscriptionManager];
...
extension PresenceKeysetExtension on Keyset {
  ...
  set suppressLeaveEvents(bool value) => settings[#suppressLeaveEvents] = value;
}
